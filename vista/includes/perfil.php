...
<i  id="btnperfil" class='bx bxs-user-circle'></i>
    ...
    if(isset( $_SESSION['administrador'])){
      ?>
      <h4>Hola,
      <?=  strtolower(substr($_SESSION['administrador']['correo'], 0, 20)."....")?>
      </h4>
    <?php
    }else if(isset($_SESSION['sololectura'])){
      ?>
      <h4>Hola,
      <?=  strtolower(substr($_SESSION['sololectura']['correo'], 0, 20)."....")?>
      </h4>
    <?php
    }else if(isset($_SESSION['encargado'])){
      ?>
      <h4>Hola,
        <?=  strtolower(substr($_SESSION['encargado']['correo'], 0, 20)."....")?>
      </h4>
    <?php
    }
    ?><div id="divcerrar">
