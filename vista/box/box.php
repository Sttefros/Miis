...
<!-- CAJA PRINCIPAL -->
        ...
        <h1 ><?php echo $data["titulo"]?></h1>
            ...
            <div class="table-responsive table-primary">
                <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered table-responsive table-hover" id="table_box">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nombre</th>
                        ...
                        <tbody>
                            <?php
                            if(isset($data["boxes"])){
                            foreach ($data["boxes"] as $dato){
                            ?>
                            <tr>
                                <td> <?php echo $dato['id_box'];?> </td>
                                ...
                                <?php 
                                    if(isset($_SESSION['administrador'])){
                                ?>
                                        <td> <a  class='btn-edit' href='index.php?c=box&a=modificar&id=<?php echo $dato["id_box"]?>'><i class='bx bx-edit'></i><a class='btn-delete' href='index.php?c=box&a=eliminar&id=<?php echo $dato["id_box"]?>' ><i class='bx bx-trash'></i></a> </td>
                                <?php
                                    }
                                ?>
                            </tr>
...
<script>
    ...
    var a = $('#table_box').dataTable({
                ...
                "buttons": [
                    ...
                    },
                    {
                        ...
                        action: function ( e, dt, button, config ) {
                            <?php
                            if(isset($_SESSION['administrador'])){?>
                                window.location = 'index.php?c=box&a=nuevo';
                            <?php }else{ ?>
        ...
        $('#table_box_wrapper .table-caption').text('Usuarios');
        $('#table_box_wrapper .dataTables_filter input').attr('placeholder', 'Buscar...');
</script>
