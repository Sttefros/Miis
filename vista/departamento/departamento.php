                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <a  href='index.php?c=departamento&a=eliminar&id=<?php echo $dato["id_departamento"]?>' ><button class='btn-delete' onClick='return alerta_eliminar_departamento()' ><i class='bx bx-trash'></i></button> </a> 
                                </td>
                                <?php
                                    }
                                ?>
