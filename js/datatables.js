 ...
 *   https://datatables.net/download/#bs4/jq-3.6.0/dt-1.11.5/fc-4.0.2/fh-3.2.2/r-2.2.9
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.11.5, FixedColumns 4.0.2, FixedHeader 3.2.2, Responsive 2.2.9
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.models.oSearch = {
		...
		DataTable.ext = _ext = {
			 ...
			 *  @type string
			 */
			build:"bs4/jq-3.6.0/dt-1.11.5/fc-4.0.2/fh-3.2.2/r-2.2.9",
